...
const propsData = [
  ...
  {
    "default": "\"BE\"",
    "description": "<p>Default country code when no initial value is provided or the value cannot be parsed.</p>\n",
  ...
  {
    "default": "[]",
    "description": "<p>Country codes shown at the top of the dropdown, separated from the rest by a divider.\nShown in the order provided.</p>\n",
  ...
  {
    "default": "\"md\"",
    "description": "<p>The size of the field.</p>\n",
    "name": "size",
    "required": false,
    "type": "\"md\" | \"sm\""
  }
