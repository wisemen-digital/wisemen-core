...
const propsData = [
  ...
  {
    "description": "<p>Maps a value to its visual config (avatar, icon, status, etc.).\nUsed both in the trigger to display the selected item and in each dropdown option.\nPrefer this over per-item config — especially required for paginated selects\nwhere the selected item may not be in the loaded page.</p>\n",
    "name": "getItemConfig",
    "required": false,
    "type": "((value: NonNullable<GetValue<TValue>>) => MenuItemConfig | null) | null"
  },
  {
    "description": "<p>Enable virtual scrolling for large lists. Item heights are derived from the select size.</p>\n",
    "name": "hasVirtualScroll",
    "required": false,
    "type": "boolean | null"
  },
  {
  ...
  {
    "description": "<p>The items to display in the select.</p>\n",
    "name": "items",
    "required": true,
    "type": "SelectItem<GetValue<TValue>>[]"
  },
  {
    "default": "null",
    "description": "<p>Whether to keep the dropdown open after selecting an option.</p>\n",
    "name": "keepDropdownOpenOnSelect",
    "required": false,
    "type": "boolean | null"
  },
  {
  ...
  {
    "default": "null",
    "description": "<p>Should only be set when the dropdown list if not paginated, but is limited in the backend</p>\n",
    "name": "limit",
    "required": false,
    "type": "number | null"
  },
  ...
  {
    "default": "null",
    "description": "<p>The search mode of the select.</p>\n<ul>\n<li><code>local</code>: filtering is done on the client side</li>\n<li><code>remote</code>: filtering is done on the server side. In this mode, you need to handle the filtering logic yourself.</li>\n<li><code>null</code>: no search functionality</li>\n</ul>\n",
    "name": "search",
    "required": false,
  ...
  {
    "default": "\"md\"",
    "description": "<p>The size of the select.</p>\n",
    "name": "size",
    "required": false,
    "type": "\"md\" | \"sm\""
  }
