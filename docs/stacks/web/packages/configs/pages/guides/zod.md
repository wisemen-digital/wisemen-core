...
For more details on internationalization and managing translations across your application, see [Vue I18n Configuration](/web/packages/configs/pages/guides/vue-i18n) or [i18n Factory](/web/packages/i18n-factory/pages/getting-started/installation).
