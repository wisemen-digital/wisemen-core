...
For complete i18n-factory behavior (overrides, extended locales, and type-safety), see [i18n-factory overview](/web/packages/i18n-factory/pages/guide/overview).
