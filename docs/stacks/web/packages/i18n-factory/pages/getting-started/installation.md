...
- Learn how to [override translations](/web/packages/i18n-factory/pages/guide/overview) for specific locales
- Explore [package integration](/web/packages/i18n-factory/pages/guide/package-integration) for creating reusable i18n factories in your own packages
