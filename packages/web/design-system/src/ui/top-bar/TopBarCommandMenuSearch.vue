...
const i18n = useI18n()
const commandMenuAction = useCommandMenuAction()
</script>
  ...
  >
    <ClickableElement>
      <button
        type="button"
        class="
          flex h-7 w-full max-w-60 items-center gap-sm rounded-md!
      ...
      >
        ...
        <span class="flex-1 truncate text-left text-xxs text-placeholder">
          {{ i18n.t('component.top_bar.search') }}
        </span>
