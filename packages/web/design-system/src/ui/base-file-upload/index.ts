export type {
  BaseFileUploadItemProps as UIBaseFileUploadItemProps,
  BaseFileUploadProps as UIBaseFileUploadProps,
} from '@/ui/base-file-upload/baseFileUpload.props'
export type {
  BaseFileInfo,
  BaseFileUploadInfo,
  BaseFileUploadItem,
...
export { default as UIBaseFileUploadTrigger } from '@/ui/base-file-upload/parts/BaseFileUploadTrigger.vue'
