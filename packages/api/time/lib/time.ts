...
export class Time {
  ...
  public static isValidTimeString (timeString?: string | null): boolean {
    ...
    return /^(?:([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]|24:00:00)$/.test(timeString)
      || /^(?:([0-1][0-9]|2[0-3]):[0-5][0-9]|24:00)$/.test(timeString)
  }
  ...
  public constructor (
    ...
    if (typeof target === 'string') {
      ...
      absoluteSeconds = this.calculateAbsoluteSeconds(hours, minutes, seconds ?? 0)
  ...
  public format (format: 'hh:mm:ss' | 'hh:mm' = 'hh:mm:ss'): string {
