...
describe('PlanningEventGenerator', () => {
  describe('generateFor', () => {
    it('should throw an error when an invalid period is given', function () {
    ...
    it('should return an empty array when the event is before the given period', function () {
      const generator = new PlanningEventGenerator()
      const from = moment()
    ...
    it('should return an empty array when the event is after the given period', function () {
      const generator = new PlanningEventGenerator()
      const from = moment()
      const until = moment(from).add(2, 'days')
      const event = createRecurringEvent({
    ...
    it('should return an empty array when the period falls between two generation candidates', function () {
      const generator = new PlanningEventGenerator()
    ...
    it('should generate events after the start date', function () {
      const generator = new PlanningEventGenerator()
      const from = moment('2023-01-10', 'YYYY-MM-DD')
    ...
    it('should generate events before the end date', function () {
      const generator = new PlanningEventGenerator()
      const from = moment('2023-01-10', 'YYYY-MM-DD')
      const until = moment('2023-01-18', 'YYYY-MM-DD')
      const event = createRecurringEvent({
    ...
    it('should generate multiple events', function () {
      const generator = new PlanningEventGenerator()
    ...
    it('generates events for infinitely recurring events', function () {
      const generator = new PlanningEventGenerator()
      const from = moment('2023-01-10', 'YYYY-MM-DD')
      const until = moment('2023-01-18', 'YYYY-MM-DD')
      const event = createRecurringEvent({
