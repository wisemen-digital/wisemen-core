...
/** 
 * Checks if a range starts at or after the given range with the `&>` operator. 
 */
export function StartsAfterOrAt (date: PlainDate): FindOperator<DateRange>
export function StartsAfterOrAt (ts: Timestamp | Date): FindOperator<DateTimeRange>
export function StartsAfterOrAt (
...
/**
 * Checks if a range starts on or after the given date with the `&>` operator.
 */
export function StartsAfterOrOn (date: PlainDate): FindOperator<DateRange> {
    return StartsAfterOrAt(date)
}
