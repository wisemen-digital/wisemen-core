...
export class WiseDate {
  ...
  public constructor (date: Date | WiseDate)
  public constructor (plainTimeObject: PlainDateObject)
  public constructor (date: number)
  public constructor (date: number | string)
  public constructor (date: string | number | Date)
  public constructor (
    input?: dayjs.Dayjs | string | Date | PlainDateObject | WiseDate | number,
    ...
    if (input === undefined) {
      ...
      if (input === Infinity || input === -Infinity || isNaN(input)) {
        throw new Error('invalid wise date, input cannot be Infinity or NaN')
      }
